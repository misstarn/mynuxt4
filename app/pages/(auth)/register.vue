    ...
    <div>
        ...
        <div>
           ...
           <v-card class="mx-auto px-12 py-8 rounded-lg max-w-[448px]" elevation="8">
               ...
               <v-btn class="mb-8" color="blue" size="large" variant="tonal" @click="login" block>Log Up</v-btn>

               <v-card-text class="text-center">
                <NuxtLink to="/login" href="#" target="_blank" rel="noopener noreferrer" class="text-blue text-decoration-none">
                    Sign In now <v-cion icon="mdi-chevron-right"></v-cion>
                </nuxtLink>
               </v-card-text>
           </v-card>
        </div>
