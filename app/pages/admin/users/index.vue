...
const headers = [
    ...
    { title: '昵称', key: 'user_profile.nickname'},
    { title: '生日', key: 'user_profile.birthday' },
    { title: 'Phone', key: 'user_profile.phone' },
    { title: '地址', key: 'user_profile.address' },
    { title: '性别', key: 'user_profile.gender' },
    { title: '状态', key: 'status' },
    { title: 'Actions', key: 'actions', align: 'end', sortable: false },
]


const { data, error, refresh } = await useAPI('/users')
    ...
    <v-dialog v-model="dialog" max-width="600">
        <v-card :title="`${isEditing ? 'Edit' : 'Add'} a User`">
            ...
            <v-card-actions class="bg-surface-light">
                ...
                <v-btn text="Save" class="my-button" @click="save"></v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
</template>
...
<style lang="scss">
    ...
    .my-button {
        height: settings.$my-button-height;
